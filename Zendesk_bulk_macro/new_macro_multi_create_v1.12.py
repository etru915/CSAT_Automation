...
def crawling_session(start_cnt):
    # 데이터 프레임 불러오기
    df = pd.read_excel('C:/Users/zeno915/Desktop/upload_list.xlsx', sheet_name='Sheet1',header=0, usecols="b:i", index_col= 'no')
    time.sleep(5)
...
# try 2 : 댓글/ 설명 작성
            try:  # try count --> 2
                if df['comment_value_html'][start_cnt] is not None:
                    ...
                    time.sleep(2)
                    driver.find_element_by_xpath('/html/body/div[1]/div/section/form/div[1]/fieldset[2]/div[2]/div/div/div/div[2]/div/div[1]/div/div[1]/div[1]').send_keys(html_text1)
...
# try 6 :우선 순위
                            try:  # try count --> 6
                                if df['priority'][start_cnt] is not None:
                                    ...
                                    driver.find_element_by_xpath('/html/body/div[1]/div/section/form/div[1]/fieldset[2]/div[2]/div/button').click()
                                    # 우선 순위 항목 선택
                                    driver.find_element_by_xpath('/html/body/div[1]/div/section/form/div[1]/fieldset[2]/div[2]/div/div/div[3]/div[1]/div/div/input').send_keys('우선 순위')
                                    driver.find_element_by_xpath('/html/body/div[1]/div/section/form/div[1]/fieldset[2]/div[2]/div/div/div[3]/div[1]/div/div/input').send_keys(Keys.ENTER)
                                    # 우선 순위 항목에 보통 입력
                                    driver.find_element_by_xpath('/html/body/div[1]/div/section/form/div[1]/fieldset[2]/div[2]/div/div/div[3]/div[2]/div/input').send_keys('Major')
                                    driver.find_element_by_xpath('/html/body/div[1]/div/section/form/div[1]/fieldset[2]/div[2]/div/div/div[3]/div[2]/div/input').send_keys(Keys.ENTER)
                                    time.sleep(0.5)
...
# try 9 : 담당자
                                        try:  # try count --> 9
                                            if df['assignee_id'][start_cnt] is not None:
                                                ...
                                                driver.find_element_by_xpath('/html/body/div[1]/div/section/form/div[1]/fieldset[2]/div[2]/div/button').click()
                                                # 담당자 선택
                                                driver.find_element_by_xpath('/html/body/div[1]/div/section/form/div[1]/fieldset[2]/div[2]/div/div/div[4]/div[1]/div/div/input').send_keys('담당자')
                                                ...
                                                driver.find_element_by_xpath('/html/body/div[1]/div/section/form/div[1]/fieldset[2]/div[2]/div/div/div[4]/div[2]/div/input').send_keys('(현재 사용자)')
...
# try 10 : 댓글모드
                                            try:  # try count --> 10
                                                if df['comment_mode_is_public'][start_cnt] is not None:
                                                    ...
                                                    driver.find_element_by_xpath('/html/body/div[1]/div/section/form/div[1]/fieldset[2]/div[2]/div/button').click()
                                                    # 댓글 모드 선택
                                                    driver.find_element_by_xpath('/html/body/div[1]/div/section/form/div[1]/fieldset[2]/div[2]/div/div/div[5]/div[1]/div/div/input').send_keys('댓글 모드')
                                                    driver.find_element_by_xpath('/html/body/div[1]/div/section/form/div[1]/fieldset[2]/div[2]/div/div/div[5]/div[1]/div/div/input').send_keys(Keys.ENTER)
                                                    driver.find_element_by_xpath('/html/body/div[1]/div/section/form/div[1]/fieldset[2]/div[2]/div/div/div[5]/div[2]/div/input').send_keys('비공개')
                                                    driver.find_element_by_xpath('/html/body/div[1]/div/section/form/div[1]/fieldset[2]/div[2]/div/div/div[5]/div[2]/div/input').send_keys(Keys.ENTER)
                                                    time.sleep(0.5)
