...
def crawling_session(start_cnt):
    ...
    time.sleep(10)
    driver.find_element_by_xpath('//*[@id="idp-discovery-username"]').send_keys("#######@coupang.com")
    time.sleep(3)
    driver.find_element_by_xpath('//*[@id="idp-discovery-submit"]').click()
    time.sleep(3)
    driver.find_element_by_xpath('//*[@id="input8"]').send_keys("*********")
    time.sleep(3)
    ...
    while start_cnt <= end_cnt:
        try:
            ...
            if df['remove_tags'][start_cnt] is not None:
                ...
                # 태그 제거 항목 선택
                driver.find_element_by_xpath('/html/body/div[1]/div/section/form/div[1]/fieldset[2]/div[2]/div/div/div[9]/div[1]/div/div/input').send_keys('태그 제거')
                ...
                time.sleep(0.5)
                # 삭제할 태그 내용 등록
                driver.find_element_by_xpath('/html/body/div[1]/div/section/form/div[1]/fieldset[2]/div[2]/div/div/div[9]/div[2]/div/div/div/input').send_keys(
                    str(df['remove_tags'][start_cnt] + " "))
                time.sleep(0.5)
                ...
                driver.find_element_by_xpath('/html/body/div[1]/div/section/form/div[1]/fieldset[2]/div[2]/div/div/div[9]').click()
                ...
                logger.info(f'{start_cnt} & 번째 --> 작업을 완료하고 등록에 성공하였습니다. &{macro_title}&')
                start_cnt += 1
            else:
