# 2021-10-03 비활성화 상태의 매크로를 활성화 상태로 변경
...
def active_macro(start_cnt) :
    end_cnt = start_cnt + 24
    ...
    def blocker_check():
        try:
            ...
            if ip_blocker == 'Your IP address is not permitted.':
                ...
                driver.get(locate1)
                time.sleep(30)
                locate2 = "https://coupangcustomersupport.zendesk.com/agent/admin/macros/"
                driver.get(locate2)
                time.sleep(10)
    ...
    try:
        ...
        time.sleep(random.randint(2,5))
        driver.find_element_by_xpath('//*[@id="input62"]').send_keys("jjangkyo21!!")
        time.sleep(random.randint(2,5))
        driver.find_element_by_xpath('//*[@id="form56"]/div[2]/input').click()  # 로그인 완료.
        ...
        driver.find_element_by_xpath('//*[@id="ember399"]').click()
        time.sleep(3)
        driver.find_element_by_xpath('//*[@id="org"]').send_keys("coupang")
        time.sleep(3)
        driver.find_element_by_xpath('//*[@id="ember490"]/div[1]/div[2]/div/div[1]/form/button').click()
        time.sleep(3)
        element = driver.find_element_by_xpath('//*[@id="ember573"]/div/a')
...
if __name__=='__main__':
    ...
    pool.map(active_macro, count_list)