...
def crawling_session(start_cnt):
    ...
    while start_cnt <= end_cnt:
        try:
            ...
            time.sleep(0.5)
            driver.find_element_by_xpath('/html/body/div/div/section/div[1]/div[1]/input').send_keys(df["title"][start_cnt])
            time.sleep(3)
            # 첫번째 검색 항목 클릭
            ...
            time.sleep(1)
            driver.find_element_by_xpath('/html/body/div[1]/div/section/form/div[1]/fieldset[1]/span/div/div[2]/div/div/div/input').send_keys('A_control-CREF')
            time.sleep(1)
            ...
            logger.info(f'&{start_cnt}& 번째 &원본& 저장을 완료하였습니다. ')
            time.sleep(5)
            try:
                ...
                time.sleep(1)
                # 2번째 항목 '복제' 클릭
                driver.find_element_by_xpath('/html/body/div/div/section/div[4]/table/tbody/tr/td[5]/div/ul/li[2]/a').click()
                time.sleep(1)
                # 새로운 제목 입력
                # driver.switch_to.frame('zendesk-clean-admin')
                driver.find_element_by_xpath('/html/body/div[1]/div/section/form/div[1]/fieldset[1]/label[1]/input').click()
                driver.find_element_by_xpath('/html/body/div[1]/div/section/form/div[1]/fieldset[1]/label[1]/input').send_keys(Keys.CONTROL + "A")
                driver.find_element_by_xpath('/html/body/div[1]/div/section/form/div[1]/fieldset[1]/label[1]/input').send_keys(Keys.DELETE)
                driver.find_element_by_xpath('/html/body/div[1]/div/section/form/div[1]/fieldset[1]/label[1]/input').send_keys(df["copy_title"][start_cnt])
                time.sleep(1)
                # 사용대상 삭제
                driver.find_element_by_xpath('/html/body/div[1]/div/section/form/div[1]/fieldset[1]/span/div/div[2]/div/ul/li[1]/span').click()
                time.sleep(1)
                ...
                driver.find_element_by_xpath('/html/body/div[1]/div/section/form/div[1]/fieldset[1]/span/div/div[2]/div/div/div/input').click()
                time.sleep(1)
                driver.find_element_by_xpath('/html/body/div[1]/div/section/form/div[1]/fieldset[1]/span/div/div[2]/div/div/div/input').send_keys('B_test-CREF')
                time.sleep(1)
                driver.find_element_by_xpath('/html/body/div[1]/div/section/form/div[1]/fieldset[1]/span/div/div[2]/div/div/div/input').send_keys(Keys.ARROW_DOWN)
                time.sleep(1)
                driver.find_element_by_xpath('/html/body/div[1]/div/section/form/div[1]/fieldset[1]/span/div/div[2]/div/div/div/input').send_keys(Keys.ENTER)
                ...
                macro_title = str(df["title"][start_cnt])
                logger.info(f'&{start_cnt}& 번째 &사본& 저장을 완료하였습니다. ')
                start_cnt += 1

            except Exception as e:  # except count --> 1
                logger.info(f'{start_cnt} 번째 사본 저장에 실패하였습니다.  :: error = {e}')
